...
class Slider extends HTMLElement {
    connectedCallback () {
        this.swipe = new Swipe( this.querySelector('.swipe'), {
            draggable: true
        })
        this.querySelector( '[slider-prev]' ).addEventListener( 'click', this.swipe.prev );
        this.querySelector( '[slider-next]' ).addEventListener( 'click', this.swipe.next );
    }
}
